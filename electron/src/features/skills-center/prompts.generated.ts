...
export const PROMPTS: PromptMeta[] = [
  ...
  },
  {
    ...
    outputs: '安装结果',
    body: `请帮我安装/启动富途 OpenD 网关：{本机安装 / 服务器安装 / 升级 futu-api SDK}。\n\n请读取 skills/install-futu-opend/SKILL.md 并按流程执行，完成后验证 OpenD 连接（端口 11111）可用。`,
  },
  {
    name: 'tigeropen',
    title: '老虎证券 OpenAPI Python SDK',
    category: '券商 SDK',
    description: '老虎证券 OpenAPI Python SDK：行情、股票/期货/期权交易、实时推送、CLI、MCP Server 集成',
    outputs: '可运行代码',
    body: `我需要用老虎证券 OpenAPI（Python）实现：{需求，如：订阅某股实时行情 / 下单 / 查询期权链 / 集成到我的应用}。\n\n请读取 skills/tigeropen/SKILL.md 获取 SDK 安装配置与 API 用法，生成可直接运行的代码，标注所需的开发者账号配置项（不硬编码密钥）。`,
  },
  {
    name: 'tigeropen-java',
    title: '老虎证券 OpenAPI Java SDK',
    category: '券商 SDK',
    description: '老虎证券 OpenAPI Java SDK：行情、交易、推送、账户管理、策略示例',
    outputs: '可运行代码',
    body: `我需要用老虎证券 OpenAPI（Java）实现：{需求，如：订阅某股实时行情 / 下单 / 查询期权链 / 集成到我的应用}。\n\n请读取 skills/tigeropen-java/SKILL.md 获取 SDK 安装配置与 API 用法，生成可直接运行的代码，标注所需的开发者账号配置项（不硬编码密钥）。`,
  },
  {
    name: 'tigeropen-cpp',
    title: '老虎证券 OpenAPI C++ SDK',
    category: '券商 SDK',
    description: '老虎证券 OpenAPI C++ SDK：SDK 编译配置、行情、交易、推送',
    outputs: '可运行代码',
    body: `我需要用老虎证券 OpenAPI（C++）实现：{需求，如：订阅某股实时行情 / 下单 / 查询期权链 / 集成到我的应用}。\n\n请读取 skills/tigeropen-cpp/SKILL.md 获取 SDK 安装配置与 API 用法，生成可直接运行的代码，标注所需的开发者账号配置项（不硬编码密钥）。`,
  },
  {
    name: 'tigeropen-csharp',
    title: '老虎证券 OpenAPI C#/.NET SDK',
    category: '券商 SDK',
    description: '老虎证券 OpenAPI C#/.NET SDK：行情、交易、推送',
    outputs: '可运行代码',
    body: `我需要用老虎证券 OpenAPI（C#/.NET）实现：{需求，如：订阅某股实时行情 / 下单 / 查询期权链 / 集成到我的应用}。\n\n请读取 skills/tigeropen-csharp/SKILL.md 获取 SDK 安装配置与 API 用法，生成可直接运行的代码，标注所需的开发者账号配置项（不硬编码密钥）。`,
  },
  {
    name: 'tigeropen-go',
    title: '老虎证券 OpenAPI Go SDK',
    category: '券商 SDK',
    description: '老虎证券 OpenAPI Go SDK：行情、交易、推送',
    outputs: '可运行代码',
    body: `我需要用老虎证券 OpenAPI（Go）实现：{需求，如：订阅某股实时行情 / 下单 / 查询期权链 / 集成到我的应用}。\n\n请读取 skills/tigeropen-go/SKILL.md 获取 SDK 安装配置与 API 用法，生成可直接运行的代码，标注所需的开发者账号配置项（不硬编码密钥）。`,
  },
  {
    name: 'tigeropen-rust',
    title: '老虎证券 OpenAPI Rust（异步） SDK',
    category: '券商 SDK',
    description: '老虎证券 OpenAPI Rust（异步） SDK：行情、交易、推送',
    outputs: '可运行代码',
    body: `我需要用老虎证券 OpenAPI（Rust（异步））实现：{需求，如：订阅某股实时行情 / 下单 / 查询期权链 / 集成到我的应用}。\n\n请读取 skills/tigeropen-rust/SKILL.md 获取 SDK 安装配置与 API 用法，生成可直接运行的代码，标注所需的开发者账号配置项（不硬编码密钥）。`,
  },
  {
    name: 'tigeropen-typescript',
    title: '老虎证券 OpenAPI TypeScript/Node.js SDK',
    category: '券商 SDK',
    description: '老虎证券 OpenAPI TypeScript/Node.js SDK：行情、交易、推送',
    outputs: '可运行代码',
    body: `我需要用老虎证券 OpenAPI（TypeScript/Node.js）实现：{需求，如：订阅某股实时行情 / 下单 / 查询期权链 / 集成到我的应用}。\n\n请读取 skills/tigeropen-typescript/SKILL.md 获取 SDK 安装配置与 API 用法，生成可直接运行的代码，标注所需的开发者账号配置项（不硬编码密钥）。`,
  },
];
